...
export function ClientMobileDrawer({ children }) {
  const sidebarOpen = useClientPortalStore((s) => s.sidebarOpen);
  ...
  return (
    <>
      ...
      {/* Panel */}
      <aside
        className={`lg:hidden fixed inset-y-0 left-0 z-50 w-72 transition-transform duration-200 shadow-[4px_0_24px_rgba(0,0,0,0.35)] ${
