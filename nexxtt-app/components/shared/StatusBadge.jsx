const STATUS = {
  pending_admin_approval: { label: "⏳ Pending Approval", cls: "bg-amber/10 text-amber border border-amber/25" },
  ...
  agency_review:          { label: "Agency Review",       cls: "bg-blue/10 text-blue border border-blue/20" },
  in_review:              { label: "Client Review",       cls: "bg-amber/10 text-amber border border-amber/20" },
  ...
  rejected:               { label: "✕ Rejected",          cls: "bg-red/10 text-red border border-red/20" },
  cancelled:              { label: "Cancelled",            cls: "bg-lg text-muted border border-border" },
